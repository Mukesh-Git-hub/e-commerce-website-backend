...
import com.example.savvyproject.entities.JWTToken;
import com.example.savvyproject.entities.User;
import com.example.savvyproject.repositories.JWTTokenRepository;
...
public class AuthService {
    ...
    public String generateToken(User user) {
        ...
        if (existingToken != null && now.isBefore(existingToken.getExpiresAt())) {
            token = existingToken.getToken();  // reuse existing valid token
        } else {
