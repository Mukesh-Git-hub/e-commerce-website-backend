...
import com.example.savvyproject.services.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<String> verifyPayment(@RequestBody Map<String, Object> requestBody, HttpServletRequest request) {
        try {
            ...
            System.out.println( "razorid"+razorpayOrderId);
            System.out.println("razorpayid"+razorpayPaymentId);
            System.out.println("razorsign"+razorpaySignature);
